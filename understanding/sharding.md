...
`fetchClientValues()` does not allow you to make use of js methods or client methods to get or process information before returning it. It only allows you to get information from client properties.
